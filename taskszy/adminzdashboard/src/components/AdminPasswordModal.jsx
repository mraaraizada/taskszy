...
export function AdminPasswordModal({ onClose, onConfirm, action = 'perform this action', label = 'Account Password' }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Get logged-in user's account password from localStorage
