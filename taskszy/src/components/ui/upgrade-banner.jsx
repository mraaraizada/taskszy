    ...
    <div className={cn("mx-auto flex items-center justify-center", className)}>
      <AnimatePresence>
        ...
        >
          ...
          <div className="relative flex h-[35px] items-center gap-1 rounded-[6px] border border-border/30 bg-background/80 pl-2.5 pr-1 text-sm backdrop-blur-sm">
            <button
              className="rounded-xs my-[-1px] cursor-pointer border-none bg-transparent px-0 py-1 font-sans text-[13px] font-medium text-foreground underline decoration-border underline-offset-[5px] outline-none hover:text-primary hover:decoration-primary/40 transition-colors"
            ...
            {onClose && (
              <button
                onClick={onClose}
                className="m-0 flex h-6 !w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-foreground hover:bg-primary/10 hover:text-primary transition-colors"
              >
                <X size={16} />
              </button>
            )}
