...
const logosRow2 = [
  ...
  { node: <><img src="/images.png" alt="LaunchWave Digital" style={{ height: '48px', width: '48px' }} /><span style={{ marginLeft: '14px', fontSize: '28px', fontWeight: '600' }}>LaunchWave Digital</span></>, title: 'LaunchWave Digital' },
